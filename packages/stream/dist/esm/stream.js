...
var NativeStream = (function (_super) {
    ...
    NativeStream.prototype._findWithDrawEscrowAccount = function (walletAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, web3_js_1.PublicKey.findProgramAddress([Buffer.from(constants_1.WITHDRAW_SOL_STRING), walletAddress.toBuffer()], this._programId)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, INSTRUCTIONS.createDepositSolInstruction(senderAddress, zebecWalletAddress, amount, this._programId)];
                    case 2:
                        ix = _b.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4, this._findWithDrawEscrowAccount(senderAddress)];
                    case 2:
                        _b = _c.sent(), withdrawEscrow = _b[0], _ = _b[1];
                        return [4, INSTRUCTIONS.createWithdrawDepositedSolInstruction(senderAddress, zebecWalletAddress, withdrawEscrow, amount, this._programId)];
                    case 3:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4, INSTRUCTIONS.createInitSolStreamInstruction(senderAddress, recipientAddress, tx_escrow, withdraw_escrow, this._programId, start_time, end_time, amount)];
                    case 2:
                        ix = _b.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, INSTRUCTIONS.createPauseSolStreamInstruction(senderAddress, recipientAddress, escrowAddress, this._programId)];
                    case 1:
                        ix = _a.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        recipientAddress = new web3_js_1.PublicKey(receiver);
                        escrowAddress = new web3_js_1.PublicKey(pda);
                        return [4, INSTRUCTIONS.createResumeSolStreamInstruction(senderAddress, recipientAddress, escrowAddress, this._programId)];
                    case 1:
                        ix = _a.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b = _c.sent(), withdrawEscrow = _b[0], _ = _b[1];
                        return [4, INSTRUCTIONS.createCancelSolStreamInstruction(senderAddress, recipientAddress, escrowAddress, zebecWallet, withdrawEscrow, this._programId)];
                    case 3:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4, INSTRUCTIONS.createWithdrawSolStreamInstruction(senderAddress, recipientAddress, escrowAddress, zebecWalletAddress, withdrawEscrowAddress, amount, this._programId)];
                    case 3:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
...
var TokenStream = (function (_super) {
    ...
    TokenStream.prototype._findWithDrawEscrowAccount = function (walletAddress, tokenMintAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, web3_js_1.PublicKey.findProgramAddress([Buffer.from(constants_1.WITHDRAW_TOKEN_STRING), walletAddress.toBuffer(), tokenMintAddress.toBuffer()], this._programId)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    TokenStream.prototype._findAssociatedTokenAddress = function (walletAddress, tokenMintAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, web3_js_1.PublicKey.findProgramAddress([walletAddress.toBuffer(), spl_token_1.TOKEN_PROGRAM_ID.toBuffer(), tokenMintAddress.toBuffer(),], new web3_js_1.PublicKey(constants_1.SPL_ASSOCIATED_TOKEN_ACCOUNT_PROGRAM_ID))];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, this._findWithDrawEscrowAccount(senderAddress, tokenMintAddress)];
                    case 1:
                        _a = _b.sent(), withdrawEscrowAddress = _a[0], _ = _a[1];
                        escrowAddress = new web3_js_1.Keypair();
                        return [4, INSTRUCTIONS.createInitMultiTokenStreamInstruction(senderAddress, recipientAddress, escrowAddress.publicKey, withdrawEscrowAddress, this._programId, tokenMintAddress, start_time, end_time, amount)];
                    case 2:
                        ix = _b.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        recipientAddress = new web3_js_1.PublicKey(receiver);
                        escrowAddress = new web3_js_1.PublicKey(pda);
                        return [4, INSTRUCTIONS.createPauseMultiTokenStreamInstruction(senderAddress, recipientAddress, escrowAddress, this._programId)];
                    case 1:
                        ix = _a.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        recipientAddress = new web3_js_1.PublicKey(receiver);
                        escrowAddress = new web3_js_1.PublicKey(pda);
                        return [4, INSTRUCTIONS.createResumeMultiTokenStreamInstruction(senderAddress, recipientAddress, escrowAddress, this._programId)];
                    case 1:
                        ix = _a.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4, this._findAssociatedTokenAddress(new web3_js_1.PublicKey(constants_1.FEE_ADDRESS), tokenMintAddress)];
                    case 5:
                        feeAssociatedTokenAddress = _c.sent();
                        return [4, INSTRUCTIONS.createCancelMultiTokenStreamInstruction(senderAddress, recipientAddress, tokenMintAddress, zebecWalletAddress, escrowAddress, withdrawEscrowAddress, this._programId, recipientAssociatedTokenAddress, zebecWalletAssociatedTokenAddress, feeAssociatedTokenAddress)];
                    case 6:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        zebecWalletAssociatedTokenAddress = _c.sent();
                        return [4, this._findAssociatedTokenAddress(_FEE_ADDRESS, tokenMintAddress)];
                    case 4:
                        feeAssociatedTokenAddress = _c.sent();
                        return [4, this._findWithDrawEscrowAccount(senderAddress, tokenMintAddress)];
                    case 5:
                        _b = _c.sent(), withdrawEscrowAddress = _b[0], __ = _b[1];
                        return [4, INSTRUCTIONS.createWithdrawMultiTokenStreamInstruction(senderAddress, recipientAddress, zebecWalletAddress, escrowAddress, withdrawEscrowAddress, _TOKEN_PROGRAM_ID_, tokenMintAddress, _SYSTEM_RENT, zebecWalletAssociatedTokenAddress, recipientAssociatedTokenAddress, _A_TOKEN, _FEE_ADDRESS, feeAssociatedTokenAddress, this._programId, amount)];
                    case 6:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _SYSTEM_RENT = new web3_js_1.PublicKey(constants_1.SYSTEM_RENT);
                        _A_TOKEN = new web3_js_1.PublicKey(constants_1.A_TOKEN);
                        return [4, INSTRUCTIONS.createDepositMultiTokenInstruction(senderAddress, zebecWalletAddress, _TOKEN_PROGRAM_ID_, tokenMintAddress, _SYSTEM_RENT, senderAssociatedTokenAddress, zebecWalletAssociatedTokenAddress, _A_TOKEN, this._programId, amount)];
                    case 4:
                        ix = _b.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        zebecWalletAssociatedTokenAddress = _c.sent();
                        _TOKEN_PROGRAM_ID_ = new web3_js_1.PublicKey(constants_1._TOKEN_PROGRAM_ID);
                        return [4, INSTRUCTIONS.createWithdrawDepositedTokenInstruction(senderAddress, _TOKEN_PROGRAM_ID_, tokenMintAddress, senderAssociatedTokenAddress, zebecWalletAddress, withdrawEscrowAddress, zebecWalletAssociatedTokenAddress, this._programId, amount)];
                    case 5:
                        ix = _c.sent();
                        tx = new web3_js_1.Transaction().add(__assign({}, ix));
                        return [4, this._connection.getRecentBlockhash()];
