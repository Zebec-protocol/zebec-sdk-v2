export declare enum INSTRUCTION {
    INIIT_SOL_STREAM = 0,
    WITHDRAW_SOL_STREAM = 1,
    CANCEL_SOL_STREAM = 2,
    INIT_TOKEN_STREAM = 3,
    PAUSE_SOL_STREAM = 4,
    RESUME_SOL_STREAM = 5,
    WITHDRAW_TOKEN_STREAM = 6,
    DEPOSIT_SOL = 7,
    CANCEL_TOKEN_STREAM = 8,
    PAUSE_TOKEN_STREAM = 9,
    RESUME_TOKEN_STREAM = 10,
    DEPOSIT_TOKEN = 11,
    FUND_SOL = 12,
    FUND_TOKEN = 13,
    WITHDRAW_SOL = 14,
...
export declare const A_TOKEN = "ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL";
